...
<main class="wrap">
  ...
  <section>
    ...
    <div class="grid grid--3">
      ...
      <div class="card"><div class="ico">🎼</div><h3>Jam-along timeline</h3><p>Press <kbd>B</kbd> to import backing tracks (MP3/WAV/FLAC) as stacked rows, play along, loop a section, and adjust each track's gain and mute. Show or hide panels with <kbd>1</kbd>/<kbd>2</kbd>/<kbd>3</kbd>.</p></div>
      <div class="card"><div class="ico">⏺️</div><h3>Re-ampable raw takes</h3><p>Press <kbd>R</kbd> to capture dry guitar onto the timeline, then shape it with the live rig — change a pedal or amp and the same take changes with it.</p></div>
